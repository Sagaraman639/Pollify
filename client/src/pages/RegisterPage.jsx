      ...
      <div className="mx-auto grid min-h-[calc(100vh-7rem)] w-full max-w-[1200px] items-center gap-10 lg:grid-cols-[1fr_0.9fr]">
        <section className="hidden lg:block">
          ...
          <h1 className="mt-4 max-w-2xl text-5xl font-black leading-tight tracking-tight text-slate-950">
            Build better polls with a workspace that feels organized from day one.
          </h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Create, share, and analyze polls with a simple account built for fast decisions.
          </p>
        </section>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Join Pollify and launch your first poll in minutes.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div>
              <label htmlFor="name" className="mb-2 block text-sm font-black text-slate-900">
                Full name
              </label>
              <input
                type="text"
